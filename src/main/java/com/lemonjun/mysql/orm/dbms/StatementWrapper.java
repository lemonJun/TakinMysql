...
public class StatementWrapper implements Statement {
    ...
    public StatementWrapper(Statement internalStatement, String sql, ConnectionWrapper connection) {
        //		this.sql = sql;
        this.internalStatement = internalStatement;
        this.connection = connection;
    }

    public StatementWrapper(Statement internalStatement, ConnectionWrapper connection) {
