...
//
//public class BJ58ProcCSCreater extends PSCreaterBase {
//
//    @Override
//    public <I> CallableStatement createDelete(Class<?> clazz, Connection connection, I id, OutSQL sql) throws Exception {
...
//
//    @Override
//    public CallableStatement createDeleteByCustom(Class<?> clazz, Connection connection, String condition, OutSQL sql) throws Exception {
//        ProcedureName des = Common.getProc(clazz);
//        if (des != null) {
//            StringBuffer sbSql = new StringBuffer("{call ");
//            sbSql.append(des.delete());
...
//
//    @Override
//    public CallableStatement createGetByCustom(Class<?> clazz, Connection connection, String columns, String condition, String orderBy, OutSQL sql) throws Exception {
//
//        ProcedureName des = Common.getProc(clazz);
//        if (des != null) {
//            StringBuffer sbSql = new StringBuffer("{call ");
...
//
//    @Override
//    public CallableStatement createGetByPage(Class<?> clazz, Connection connection, String condition, String columns, int page, int pageSize, String orderBy, OutSQL sql) throws Exception {
//
//        ProcedureName des = Common.getProc(clazz);
//        if (des != null) {
//            StringBuffer sbSql = new StringBuffer("{call ");
...
//
//    @Override
//    public <I> CallableStatement createGetEntity(Class<?> clazz, Connection connection, I id, OutSQL sql) throws Exception {
//        List<Field> fieldList = Common.getIdFields(clazz);
//        if (fieldList.size() != 1) {
...
//
//    @Override
//    public CallableStatement createUpdateByCustom(Class<?> clazz, Connection connection, String updateStatement, String condition, OutSQL sql) throws Exception {
//
//        ProcedureName des = Common.getProc(clazz);
//        if (des != null) {
//            StringBuffer sbSql = new StringBuffer("{call ");
...
//
//    @Override
//    public CallableStatement createUpdateEntity(Object bean, Connection connection, OutSQL sql) throws Exception {
...
//
//    @Override
//    public CallableStatement createInsert(Object bean, Connection connection, OutSQL sql) throws Exception {
